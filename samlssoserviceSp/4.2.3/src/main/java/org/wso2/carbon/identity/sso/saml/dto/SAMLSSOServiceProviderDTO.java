...
public class SAMLSSOServiceProviderDTO implements Serializable {
    ...
    private String useFullyQualifiedUsernameS;
    private String doSingleLogoutS;
    private String doSignAssertionsS;
    private String doSignResponseS;
    private String enableAttributesByDefaultS;
    private String idPInitSSOEnabledS;
    private String doEnableEncryptedAssertionS;
    private String doValidateSignatureInRequestsS;
    ...
    public String getUseFullyQualifiedUsernameS() {
        return useFullyQualifiedUsernameS;
    }

    public void setUseFullyQualifiedUsernameS(String useFullyQualifiedUsernameS) {
        this.useFullyQualifiedUsernameS = useFullyQualifiedUsernameS;
    }

    public String getDoSingleLogoutS() {
        return doSingleLogoutS;
    }

    public void setDoSingleLogoutS(String doSingleLogoutS) {
        this.doSingleLogoutS = doSingleLogoutS;
    }

    public String getDoSignAssertionsS() {
        return doSignAssertionsS;
    }

    public void setDoSignAssertionsS(String doSignAssertionsS) {
        this.doSignAssertionsS = doSignAssertionsS;
    }

    public String getDoSignResponseS() {
        return doSignResponseS;
    }

    public void setDoSignResponseS(String doSignResponseS) {
        this.doSignResponseS = doSignResponseS;
    }

    public String getEnableAttributesByDefaultS() {
        return enableAttributesByDefaultS;
    }

    public void setEnableAttributesByDefaultS(String enableAttributesByDefaultS) {
        this.enableAttributesByDefaultS = enableAttributesByDefaultS;
    }

    public String getIdPInitSSOEnabledS() {
        return idPInitSSOEnabledS;
    }

    public void setIdPInitSSOEnabledS(String idPInitSSOEnabledS) {
        this.idPInitSSOEnabledS = idPInitSSOEnabledS;
    }

    public String getDoEnableEncryptedAssertionS() {
        return doEnableEncryptedAssertionS;
    }

    public void setDoEnableEncryptedAssertionS(String doEnableEncryptedAssertionS) {
        this.doEnableEncryptedAssertionS = doEnableEncryptedAssertionS;
    }

    public String getDoValidateSignatureInRequestsS() {
        return doValidateSignatureInRequestsS;
    }

    public void setDoValidateSignatureInRequestsS(String doValidateSignatureInRequestsS) {
        this.doValidateSignatureInRequestsS = doValidateSignatureInRequestsS;
    }

    public String convertBoolToString(String status, String variablename) {

        if (variablename.equals("useFullyQualifiedUsernameS")) {
