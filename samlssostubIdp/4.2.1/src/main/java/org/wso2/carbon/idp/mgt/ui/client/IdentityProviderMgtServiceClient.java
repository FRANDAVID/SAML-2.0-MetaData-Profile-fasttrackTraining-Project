...
public class IdentityProviderMgtServiceClient {
    ...
    public String addMetadataServiceProviderFileContentOnly(String fileContent, String issuer) throws AxisFault {
        ...
        String strstatus;
        try {
            strstatus = idPMgtStub.isMetadataFileAdded(fileContent, issuer);
    ...
    public SAMLSSOIdentityProviderDTO addMetadataServiceProviderSAMLObjectOnly(String fileContent) throws AxisFault {

        SAMLSSOIdentityProviderDTO samlssoIdentityProviderDTO;
        try {
            samlssoIdentityProviderDTO = idPMgtStub.addMetadataServiceProvider(fileContent);
        } catch (Exception e) {
