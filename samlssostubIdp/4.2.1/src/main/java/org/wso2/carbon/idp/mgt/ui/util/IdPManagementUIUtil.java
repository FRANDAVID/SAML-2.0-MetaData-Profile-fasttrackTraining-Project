...
public class IdPManagementUIUtil {
    ...
    public static String getFileContent(HttpServletRequest request,String test) {
        ...
        System.out.println("testing file data method getfilecontent");
        ...
        try {
            System.out.println("testing file data method getfilecontent enter try block");
            System.out.println(ServletFileUpload.isMultipartContent(request));
            //System.out.println("testing file data");
            if (ServletFileUpload.isMultipartContent(request)) {
                System.out.println("testing file data method getfilecontent enter try block and if condition");
                ...
                System.out.println("check items list"+items.isEmpty());
