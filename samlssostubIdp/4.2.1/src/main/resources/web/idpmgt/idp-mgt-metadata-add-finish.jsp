...
<%
    ...
    String idpNme = CharacterEncoder.getSafeText(request.getParameter("idPName"));
    System.out.println("idpName check second "+idpNme);
    ...
    if (idpAction != null && "addIdentityProviderFromFile".equals(idpAction)) {
               ...
               String fileContent = IdPManagementUIUtil.getFileContent(request,"test");
                ...
                String chkrecieved = IdPManagementUIUtil.chkStringReturn("this is checking ");
                System.out.println("@@@@@@"+chkrecieved);

                retrievedObject = client.addMetadataServiceProviderSAMLObjectOnly(fileContent);
                System.out.println(retrievedObject);

                 provider = retrievedObject;
                 System.out.println("###################1"+provider.getIdpEntityId());
                 System.out.println("###################2"+provider.getSpEntityId());
                 System.out.println("###################3"+provider.getUrlSSO());
                ...
                <table class="carbonFormTable">
                    ...
                    <tr>
                                            ...
                                            <td>
                                                ...
                                                <input type="file" id="metaFile" name="metaFile" size="60" />

                                            </td>

                                             <td>

                                                <input type="submit" value="upload file" formaction="idp-mgt-metadata-add-finish.jsp?idpAction=addIdentityProviderFromFile&idPName=raji" formenctype="multipart/form-data" formmethod="post" />
