...
public class SAMLSSOConfigServiceClient {
    ...
    public String addMetadataServiceProviderFileContentOnly(String fileContent, String issuer) throws AxisFault {
        ...
        try {
            ...
            log.error("Error adding a new Service Provider file 1", e);
            throw new AxisFault(e.getMessage(), e);
        }
        return strstatus;
    ...
    public SAMLSSOServiceProviderDTO addMetadataServiceProviderSAMLObjectOnly(String fileContent) throws AxisFault {

        SAMLSSOServiceProviderDTO samlssoServiceProviderDTO;
        try {
            samlssoServiceProviderDTO = stub.addMetadataServiceProvider(fileContent);
        } catch (Exception e) {
