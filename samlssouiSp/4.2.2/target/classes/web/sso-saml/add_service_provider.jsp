...
<form method='post' action='add_metadata_service_provider.jsp?SPAction=addServiceProviderFromFile&spName=<%=request.getParameter("spName")%>' enctype='multipart/form-data'>
