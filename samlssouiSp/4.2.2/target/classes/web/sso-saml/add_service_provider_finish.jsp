...
<%
    ...
    try {
        ...
        fileAddedStatus = client.addMetadataServiceProviderFileContentOnly(fileContent,fileIssuer);
        System.out.println(fileAddedStatus);
        ...
        String message;
        if (status && "true".equals(fileAddedStatus)) {
			if (isEditingSP) {
